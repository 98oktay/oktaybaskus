...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (a, b, c, d) {
        var r, s, t, u, e = function () {
        ...
        }, f = 999999999999999, g = 1e-10, h = {x: 1, y: 1, z: 2, scale: 1, scaleX: 1, scaleY: 1, rotation: 1, rotationZ: 1, rotationX: 2, rotationY: 2, skewX: 1, skewY: 1}, i = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), j = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47), k = function (a) {
            ...
            return!1
        }(window ? "www.greensock.com" : ""), l = function (a, b, c, d) {
            ...
            return e > c ? e = c : d > e && (e = d), {max: e, min: e}
            ...
            var t, u, v, w, x, y, z, A, B, C, k = 0, l = 9999999999, p = f.throwProps || f, q = f.ease instanceof c ? f.ease : f.ease ? new c(f.ease) : b.defaultEase, r = isNaN(p.checkpoint) ? .05 : Number(p.checkpoint), s = isNaN(p.resistance) ? e.defaultResistance : Number(p.resistance);
            for (t in p)"resistance" !== t && "checkpoint" !== t && "preventOvershoot" !== t && (u = p[t], "object" != typeof u && (B = B || d.getByTarget(a), B && B.isTrackingProp(t) ? u = "number" == typeof u ? {velocity: u} : {velocity: B.getVelocity(t)} : (w = Number(u) || 0, v = w * s > 0 ? w / s : w / -s)), "object" == typeof u && (void 0 !== u.velocity && "number" == typeof u.velocity ? w = Number(u.velocity) || 0 : (B = B || d.getByTarget(a), w = B && B.isTrackingProp(t) ? B.getVelocity(t) : 0), x = isNaN(u.resistance) ? s : Number(u.resistance), v = w * x > 0 ? w / x : w / -x, y = "function" == typeof a[t] ? a[t.indexOf("set") || "function" != typeof a["get" + t.substr(3)] ? t : "get" + t.substr(3)]() : a[t] || 0, z = y + n(w, q, v, r), void 0 !== u.end && (u = m(u, z, u.max, u.min)), void 0 !== u.max && z > Number(u.max) + g ? (C = u.unitFactor || 1, A = y > u.max && u.min !== u.max || w * C > -15 && 45 > w * C ? i + .1 * (h - i) : o(y, u.max, w, q, r), l > A + j && (l = A + j)) : void 0 !== u.min && z < Number(u.min) - g && (C = u.unitFactor || 1, A = y < u.min && u.min !== u.max || w * C > -45 && 15 > w * C ? i + .1 * (h - i) : o(y, u.min, w, q, r), l > A + j && (l = A + j)), A > k && (k = A)), v > k && (k = v));
        ...
        return q.constructor = e, e.version = "0.9.2", e.API = 2, e._autoCSS = !0, e.defaultResistance = 100, e.track = function (a, b, c) {
            ...
            if (a) {
                var b = a._internals, c = b._parseToProxy, f = b._setPluginRatio, g = b.CSSPropTween;
                b._registerComplexSpecialProp("throwProps", {parser: function (a, b, i, j, k, l) {
                    l = new e;
                    var u, v, w, x, y, m = {}, n = {}, o = {}, p = {}, q = {}, t = {};
                    s = {};
                    ...
                    for (w in r)s[w] = {velocity: m[w], min: n[w], max: o[w], end: p[w], resistance: q[w], preventOvershoot: t[w]};
            ...
            c.throwProps || (c = {throwProps: c}), 0 === f && (c.throwProps.preventOvershoot = !0);
            var g = new b(a, 1, c);
            return g.render(0, !0, !0), g.vars.css ? (g.duration(p(r, {throwProps: s, ease: c.ease}, d, e, f)), g._delay && !g.vars.immediateRender ? g.invalidate() : t._onInitTween(r, u, g), g) : (g.kill(), new b(a, p(a, c, d, e, f), c))
            ...
            var o, p, q, r, s, v, w, x, y, e = c._ease, f = isNaN(b.checkpoint) ? .05 : Number(b.checkpoint), g = c._duration, h = b.preventOvershoot, l = 0;
            for (o in b)if ("resistance" !== o && "checkpoint" !== o && "preventOvershoot" !== o) {
                if (p = b[o], "number" == typeof p)s = Number(p) || 0; else if ("object" != typeof p || isNaN(p.velocity)) {
        ...
        var b, c, d, e, f = /([A-Z])/g, g = {}, h = {x: 1, y: 1, z: 2, scale: 1, scaleX: 1, scaleY: 1, rotation: 1, rotationZ: 1, rotationX: 2, rotationY: 2, skewX: 1, skewY: 1}, i = document.defaultView ? document.defaultView.getComputedStyle : function () {
        }, j = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), k = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47), l = function (a) {
            for (var b = [j, String.fromCharCode(99, 111, 100, 101, 112, 101, 110, 46, 105, 111), String.fromCharCode(99, 100, 112, 110, 46, 105, 111), String.fromCharCode(103, 97, 110, 110, 111, 110, 46, 116, 118), String.fromCharCode(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116), String.fromCharCode(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116), String.fromCharCode(99, 101, 114, 101, 98, 114, 97, 120, 46, 99, 111, 46, 117, 107)], c = b.length; --c > -1;)if (-1 !== a.indexOf(b[c]))return!0;
            return!1
        }(window ? "www.greensock.com" : ""), m = function (a, b, c) {
            ...
            var f, g, a = b, c = n.time;
            if (c - d >= .03)for (e = d, d = c; a;) {
        ...
        return s.addProp = function (b, c) {
            if (!this._lookup[b]) {
                ...
                this._firstVP = this._lookup[b] = this._lookup[f] = g = new o(f !== b && 0 === b.indexOf("set") ? f : b, e, g), g.css = this.elem && (void 0 !== this.target.style[g.p] || h[g.p]), g.css && h[g.p] && !d._gsTransform && a.set(d, {x: "+=0"}), g.type = c || g.css && 0 === b.indexOf("rotation") ? "deg" : "", g.v1 = g.v2 = g.css ? m(d, g.p) : e ? d[g.p]() : d[g.p]
            }
            ...
            var d, e, f, b = this._lookup[a], c = this.target;
        ...
        }, l ? q : ( console.log("http://" + j + k + "?plugin=VelocityTracker", !1))
    }, !0)
